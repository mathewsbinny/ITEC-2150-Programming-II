/*
 * Triangle of Sierpinski (Source: http://creativecommons.org/publicdomain/zero/1.0/) 
*/
...
void setup() {
  ...
  triangleSier(0, 700, 400, 0, 800, 700,6);
...
void triangleSier(float x1, float y1, float x2, float y2, float x3, float y3, int n) {
  ...
  return;
     ...
     fill(0, 0, 0); //to show when n is 1, the color will be black instead of red.
